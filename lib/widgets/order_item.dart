                        ...
                        child: Row(children: <Widget>[
                           ...
                           IconButton(
                             ...
                             onPressed: (widget.order.noCerrado == "1")
                                 ? () {
                                     reloadCard(context, widget.order.products,
                                         widget.order);
                                   }
                                 : null,
                           ),
                            IconButton(
                             ...
                             onPressed: () {
                                   final url="https://distribuidorainsucor.com/tuPedido.php?id="+widget.order.idOrder;
                                     FlutterOpenWhatsapp.sendSingleMessage("54"+widget.order.telefono, url);
                                   },
                           ),

                          // PARA COMPARTIR.. SE USA EL SHARE
                          // RaisedButton(
                          //   onPressed: (){
                          ...
                          //   }
                            ...
                            //       subject: 'holll', sharePositionOrigin: box.localToGlobal(Offset.zero)& box.size);
                            // },
                          //)
                        ])),
                  ),
